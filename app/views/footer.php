<!-- <footer class="footer-section">
                    ...
                    <div class="col-xl-4 col-lg-4 mb-50">
                        <div class="footer-widget">
                            <div class="footer-logo">
                                <a href="index.html"><img src="/Ecom-store-project/app/assets/images/login_store_logos-2 (1).png" style="/* width:20%; *//* height:50%; */" class="img-fluid" alt="logo"></a>
                            </div>
                            <div class="footer-text">
                                <p>عبارة عن موقع الكتروني تستطيع من خلاله الشراء اون لاين عبر الهاتف المحمول او جهاز الكمبيوتر لكل احتياجاتك الكتروني</p>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                        <div class="footer-widget">
                            ...
                            <ul>
                                ...
                                <li><a href="#">الاسئلة الشائعة FAQs</a></li>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-50">
                        <div class="footer-widget">
                            ...
                            <div class="footer-text mb-25">
                                <p>خصومات حصريةاشترك في القائمة البريدية للحصول على احدث أخبار و عروض </p>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 text-center text-lg-left">
                        <div class="copyright-text">
                            <p>2020 © جميع الحقوق محفوظة لواجن ستور &copy; </p>
                        </div>
                    </div>
    ...
    <script src='/Ecom-store-project/app/assets/js/bootstrap.js'></script>
    <script src="https://unpkg.com/swiper/swiper-bundle.js"></script>
    <script src="https://unpkg.com/swiper/swiper-bundle.min.js"></script>
    <script type="text/javascript" src="/Ecom-store-project1/app/assets/js/main.js"></script>
